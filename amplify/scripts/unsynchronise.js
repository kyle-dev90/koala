...
const shouldUnsynchronize = (model) => {
    return model.attributes.some((attr) => attr.properties.subscriptions === null)
}

const schemaRaw = fs.readFileSync(`${__dirname}/../../src/models/schema.js`, "utf-8")
...
fs.writeFileSync(
    ...
    `export const schema=${JSON.stringify(schemaCpy)};`,
    "utf8"
)
